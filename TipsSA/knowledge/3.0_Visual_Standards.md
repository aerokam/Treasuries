...
## Overview
The TIPS Portal charts are designed for professional financial analysis, prioritizing precision, logical grid alignment, and fluid navigation across the maturity timeline.
...
1.  **Ask (Square)**: The raw, unadjusted broker quote. (Bottom-most Z-index).
2.  **Seasonally Adjusted (SA) (Cross)**: The primary math transform. (Middle Z-index).
