...
| **Ref CPI Refresh** | 9:30 AM ET on each BLS release date, retries every 30 min up to 6h if TreasuryDirect hasn't caught up | `scripts/fetchRefCpi.js` (`run-ref-cpi.cmd`) | `TIPS/RefCPI.csv` |
