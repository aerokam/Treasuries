...
- **[Quantity](./GLOSSARY.md#quantity):** Number of TIPS held; qty 1 = $1,000 face value (e.g., qty 50 = $50,000 face value).
- **[Face Value](./GLOSSARY.md#face-value):** Quantity × $1,000 (e.g., $50,000).
- **[Par Value (Adjusted Principal)](./GLOSSARY.md#par-value-adjusted):** The principal value after being adjusted for inflation/deflation.
...
- **[Reference CPI](./GLOSSARY.md#ref-cpi):** Daily interpolated value used for TIPS calculations.
...
- **[Index Ratio](./GLOSSARY.md#index-ratio):**
```
...
**[P+I per TIPS](./GLOSSARY.md#pi-per-tips):**
...
**[Cost per TIPS](./GLOSSARY.md#cost-per-tips):**
