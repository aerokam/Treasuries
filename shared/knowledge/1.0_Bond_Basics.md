...
**Quantity:** The number of $1,000 units of a security (e.g., 50).

**Face Value:** The original, unadjusted principal amount of a security (e.g., $50,000 for a quantity of 50). This is the baseline amount used as the unit of account. 

**Par Value:** The current principal value of the security. For nominal Treasuries, Par Value equals Face Value. For TIPS, Par Value includes inflation adjustments (Face Value × Index Ratio).

**Annual Interest:**
The fixed annual coupon rate multiplied by the Face Value (for nominals) or Par Value (for TIPS).
```
