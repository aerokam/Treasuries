...
// 1. Kevin_IRA holdings (Format 3 — derived from real Schwab data, generated by scripts/generate-test-fixtures.js)
runFullRebalanceTest('Kevin_IRA', './tests/e2e/KevinIraHoldings.csv');
...
//    Uses Kevin_IRA 2031-2035 bonds (far from maturity, stable for years).
{
