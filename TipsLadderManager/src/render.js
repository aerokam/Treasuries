...
export const COLS = [
  ...
  { label: 'CUSIP',       key: 'cusip',       fmt: 'str',
    ...
    headerHTML: 'Funded Year<br><span style="font-weight:normal;opacity:0.75">CUSIP (expand)</span>' },
  { label: 'Maturity',    key: 'maturity',    fmt: 'str',
    value: d => d.maturityStr, subValue: d => d.maturityStr,
    headerHTML: '<span style="visibility:hidden">.</span><br><span style="font-weight:normal;opacity:0.75">Maturity (expand)</span>' },
  { label: 'Yield',       key: 'yield',       fmt: 'yld', buildOnly: true,
    value: d => d.yield, subValue: d => d.yield,
    headerHTML: '<span style="visibility:hidden">.</span><br><span style="font-weight:normal;opacity:0.75">Yield (expand)</span>' },
  // Rebalance-only
  ...
  { label: 'Cost Before',   key: 'costBefore', fmt: 'amt', rebalOnly: true,
    ...
    headerHTML: 'Cost Before<br><span style="font-weight:normal;opacity:0.75">(expand)</span>' },
  ...
  { label: 'Cost After',    key: 'costAfter',  fmt: 'amt', rebalOnly: true,
    ...
    drill: true, drillCond: v => typeof v === 'number' && v > 0,
    headerHTML: 'Cost After<br><span style="font-weight:normal;opacity:0.75">(expand)</span>' },
  ...
  { label: 'Quantity Before',    key: 'qtyBefore',  fmt: 'qty', rebalOnly: true,
    ...
    headerHTML: 'Qty Before<br><span style="font-weight:normal;opacity:0.75">(expand)</span>' },
  ...
  { label: 'Quantity After',     key: 'qtyAfter',   fmt: 'qty', rebalOnly: true,
    ...
    headerHTML: 'Qty After<br><span style="font-weight:normal;opacity:0.75">(expand)</span>' },
  ...
  { label: 'Quantity Delta',     key: 'qtyDelta',   fmt: 'sgn', rebalOnly: true,
    ...
    headerHTML: 'Qty Delta<br><span style="font-weight:normal;opacity:0.75">(expand)</span>' },
  ...
  { label: 'Cash Delta',    key: 'cashDelta',  fmt: 'sgn', rebalOnly: true,
    ...
    drill: true, drillCond: v => typeof v === 'number' && v !== 0,
    headerHTML: 'Cash Delta<br><span style="font-weight:normal;opacity:0.75">(expand)</span>' },
  ...
  { label: 'Cost',   key: 'cost',   fmt: 'amt', buildOnly: true,
    ...
    drill: true, drillCond: () => true,
    headerHTML: 'Cost<br><span style="font-weight:normal;opacity:0.75">(expand)</span>' },
  ...
  { label: 'Quantity',    key: 'qty',    fmt: 'qty', buildOnly: true,
    ...
    headerHTML: 'Qty<br><span style="font-weight:normal;opacity:0.75">(expand)</span>' },
];
