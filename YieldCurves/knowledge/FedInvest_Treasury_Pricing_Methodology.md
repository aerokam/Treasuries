...
**Reference for:** [3.1 Parse sources and calculate yields](./3.1_Parse_Sources_And_Calculate_Yields.md#parse-fedinvest-prices), [FedInvest Pricing Logic](./FedInvest_Pricing_Logic.md)
